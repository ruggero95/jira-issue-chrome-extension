...
export const CustomRadio:React.FC<{id:string, label?:string,name:string, value:string, checked:boolean, onChange?: React.ChangeEventHandler<HTMLInputElement> | undefined, }>  = ({id, label, checked, name,value, onChange}) => {
    return (
        <div className="flex items-center mr-4">
            <input onChange={onChange} id={id} type="radio" value={value} checked={checked} name={name} className="w-4 h-4 cursor-pointer text-red-600 dark:text-red-600 bg-gray-100 border-gray-300 focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 focus:ring-2 " />
